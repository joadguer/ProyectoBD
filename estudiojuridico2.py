...
# Cargar los datos de clientes, casos y abogados al iniciar la aplicación
...
def mostrar_casos():
    ...
    for caso in casos:
        ...
        tabla_casos.insert("", "end", values=(
            ...
            caso["estado"], 
            abogado_nombre,
            caso.get("fechaInicio", ""),  # Añadido
            caso.get("fechaFin", "")      # Añadido
        ))
...
tabla_casos = ttk.Treeview(main_frame, columns=("id", "cliente", "descripcion", "etapa", "estado", "abogado", "fechaInicio", "fechaFin"), show="headings")
